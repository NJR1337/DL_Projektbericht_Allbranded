%%%%%%%%%%%%%%%%%%%  Document info  %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\newcommand{\projname}{Projektbericht}
\newcommand{\titel}{Analyse der Kommunikationshistorie mittels Klassifikation und Auswahl geeigneter Antwortsnippets }
\newcommand{\untertitel}{}
\newcommand{\thesisname}{Projektbericht}
\newcommand{\Datum}{26. März 2025}
\newcommand{\authorname}{
    Niclas Rust\\[0.2\baselineskip]
    Marc-Louis Dederichs\\[0.2\baselineskip]
    Yue Cao\\[0.5\baselineskip]
    Luis Schwindt
}
% \newcommand{\authorname}{Niclas Rust,\\Marc-Louis Dederichs,\\Yue Cao,\\ \smallskip Luis Schwindt}
%%%%%%%%%%%%%%%%%%%  Document info  %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
